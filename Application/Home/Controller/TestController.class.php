...
//                            $this->reText( $data );
                        ...
                        case "CLICK":
                            if( $postObj->EventKey == 'binding' ){
                                $content = array();
                                $content[] = array("Title"=>"多友财通道", "Description"=>"", "PicUrl"=>"http://web.yunlaohu.cn/WxpayAPI/ok1.jpg", "Url" =>"http://mobile.yunlaohu.cn/index.php/Binding/index?openid=".$postObj->FromUserName);
                                $this->transmitNews( $postObj,$content );
                            }
                            ...
                            if( $postObj->EventKey == 'kefu' ){
                                $content = array();
                                $data['content']="/:rose多友财支付将帮您一站式解决：主流支付收款问题、门店员工管理问题、小票打印机、财务结算对账等问题，从此降低人工收银时间，减少假币风险，迅速开启智慧门店第一步。 \n\n<a href='tel:4000-600-436'>接入热线：4000-600-436</a>\n\n<a href='tel:0431-81751605'>长春地区：0431-81751605</a>\n\n<a href='tel:0438-6800333'>松原地区：0438-6800333</a> ";
                                $this->reText($data);
                            }
